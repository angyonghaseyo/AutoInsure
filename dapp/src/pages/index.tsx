    ...
    <div className="flex flex-col bg-white text-black">
      ...
      <Carousel autoplay effect="fade" dotPosition="bottom" className="custom-carousel">
        <div className="hero-section text-center bg-gradient-to-r from-blue-100 to-white py-32">
          ...
          <Paragraph className="text-xl text-gray-700 max-w-2xl mx-auto animate-slideIn">Instant payouts and transparent claims. Powered by blockchain technology.</Paragraph>
      ...
      <div id="get-started" className="py-20 bg-gray-100 text-center">
        <Paragraph className="text-lg text-gray-600">Our decentralized flight insurance platform makes protecting your travels simple and transparent.</Paragraph>

        <Row gutter={[32, 32]} justify="center">
          {/* Step 1: Purchase Insurance */}
          <Col xs={24} md={8}>
            <Card title="Purchase Insurance" className="custom-card bg-white text-black hover:shadow-xl">
          ...
          <Col xs={24} md={8}>
            <Card title="Flight Data Oracle" className="custom-card bg-white text-black hover:shadow-xl">
          ...
          {/* Step 3: Auto Payout */}
          <Col xs={24} md={8}>
            <Card title="Automatic Payout" className="custom-card bg-white text-black hover:shadow-xl">
              <ThunderboltOutlined style={{ fontSize: 60, color: "#FAAD14" }} />
              <Paragraph>If your flight is delayed or your baggage is lost, you'll receive an automatic payout to your wallet.</Paragraph>
            </Card>
          </Col>
        </Row>
      </div>
